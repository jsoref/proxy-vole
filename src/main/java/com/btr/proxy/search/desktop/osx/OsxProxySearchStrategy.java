...
public class OsxProxySearchStrategy implements ProxySearchStrategy {
	 ...
	 * @param proxySettings the dictionary containing all settings
	 * @param result the proxy selector that needs to be adapted.
	 ...
	 * @param proxySettings the settings to analyse.
	 * @param result the current proxy selector.
	 * @return a WPAD proxy selector or the passed in proxy selector.
	 * @throws ProxyException on automatic detection errors.
	 ************************************************************************/
